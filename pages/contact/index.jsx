...
const Contact =  () => {
    ...
    const servicesItems = ["Order Enquiry", "Catering", "Franchise", "Other"]

    return (
        <main className="flex overflow-hidden">
            <div className="flex-1 hidden lg:block">
                <Image src={ContactImage} className="w-full h-screen object-cover" />
            </div>
            <div className="py-12 flex-1 lg:flex lg:justify-center lg:h-screen lg:overflow-auto">
                <div className="max-w-lg flex-1 mx-auto px-4 text-gray-600">
                    ...
                    >
                        ...
                        <button
                            className="w-full px-4 py-2 text-white font-medium bg-gradient-to-bl from-orange-600 bg-orange-400  rounded-lg duration-150"
                        >
                            Submit
                        </button>
                    </form>
